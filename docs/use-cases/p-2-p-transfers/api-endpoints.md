...
Unique reference for the transaction. This is returned in the response by API provider.  | NA <br> M |  |  |
...
| debitParty | array | 	
A collection of key/value pairs that enable the debit party to be identified. Keys include MSISDN and Wallet Identifier. | O <br> O | [Account Identifiers](/use-cases/p-2-p-transfers/supporting-objects.html#account-identifiers-object) |  |
