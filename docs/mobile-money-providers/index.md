...
---
  ...
  <industry-hero-section
    ...
    :description="'A mobile money operator is a mobile money service provider that develops and delivers financial services through mobile phones and mobile telephone networks.'"
