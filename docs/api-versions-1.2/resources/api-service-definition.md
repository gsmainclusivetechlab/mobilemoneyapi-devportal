...
![Account Transaction UML Class Diagram](/images/Account-Transaction-UML-Class-Diagram.png)
...
![Account Status UML Class Diagram](/images/Account-Status-UML-Class-Diagram.png)
...
![Account Balance UML Class Diagram](/images/Account-Balance-UML-Class-Diagram.png)
...
![Account Holder Name UML Class Diagram](/images/Account-Holder-Name-UML-Class-Diagram.png)
...
![Account Holder Name UML Class Diagram](/images/Account-Statement-Entry-UML-Class-Diagram.png)
...
![Bill UML Class Diagram](/images/Bill-UML-Class-Diagram.png)
...
![Bill Payment UML Class Diagram](/images/Bill-Payment-UML-Class-Diagram.png)
...
![Bill Company UML Class Diagram](/images/Bill-Company-UML-Class-Diagram.png)
...
![Debit Mandate UML Class Diagram](/images/Debit-Mandate-UML-Class-Diagram.png)
...
![Link UML Class Diagram](/images/Link-UML-Class-Diagram.png)
...
| requestingOrganisation | object | The originating organisation of the request. | &#8594;&nbsp;O <br> &#8592; O |  | Please refer to API Fundamentals document for amount validation rules. |
| currency | string | Currency of the amount limit. | &#8594;&nbsp;O <br> &#8592; O |  | Enumeration = [ISO Currency Codes](/api-versions-1.2/resources/api-service-definition.html#iso-currency-codes) |
| endDate | date | Date on which the Debit Mandate ends. | &#8594;&nbsp;O <br> &#8592; O |  |  |
| frequencyType | string | Indicates the frequency for which payments will be taken from the payers account. | &#8594;&nbsp;O <br> &#8592; O |  | Enumeration = [Frequency](/api-versions-1.2/resources/api-service-definition.html#frequency-type) |
| numberOfPayments | number | Indicates the number of consecutive payments that are to be taken. | &#8594;&nbsp;O <br> &#8592; O |  |  |
...
![Authorisation Code UML Class Diagram](/images/Authorisation-Code-UML-Class-Diagram.png)
...
![Quotation UML Class Diagram](/images/Quotation-UML-Class-Diagram.png)
...
| type | string | The transaction type that the quotation has been requested for. | &#8594;&nbsp;O <br> &#8592; O |  | Enumeration = [Frequency](/api-versions-1.2/resources/api-service-definition.html#frequency-type) |
...
| **deliveryMethod** | string | The recipient delivery method as chosen by the sender. | &#8594;&nbsp;O <br> &#8592; O |  | [Delivery Method Types](/api-versions-1.2/resources/api-service-definition.html#delivery-method-types) |
...
| **occupation** | string | Occupation of the KYC subject. | &#8594;&nbsp;O <br> &#8592; O | [Address](/api-versions-1.2/resources/api-service-definition.html#address-object) |  |
