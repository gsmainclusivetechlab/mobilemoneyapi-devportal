...
export const RESET_PASSWORD_CONFIRMATION = USER_API.replace(
  '{endpoint}',
...
export const APPS = DEVELOPERS_API.replace(
  '{endpoint}',
  'apps?userName{userName}&searchField&searchValue&sortType'
);
export const CREATE_APP = DEVELOPERS_API.replace('{endpoint}', 'apps');
export const ALL_APPS = DEVELOPERS_API.replace(
  '{endpoint}',
  'apps?searchField{searchField}&searchValue{searchValue}&sortType{sortType}'
);
export const APP_BY_ID = DEVELOPERS_API.replace('{endpoint}', '{userName}/apps/{appId}');
export const PLANS = USAGE_PLANS.replace(
  '{endpoint}',
  'plans?planId&searchValue{searchValue}&sortType{sortType}'
);
export const ADMIN_PROFILE = ADMIN_API.replace('{endpoint}', 'profile');
export const DEVELOPERS = ADMIN_API.replace(
  '{endpoint}',
  'developers?userName{userName}&searchField{searchField}&searchValue{searchValue}&sortType{sortType}'
);
...
export const APP_ALREADY_EXISTS = 'ALREADY_EXISTS';
