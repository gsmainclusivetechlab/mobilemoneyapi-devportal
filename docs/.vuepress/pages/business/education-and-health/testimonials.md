...
<testimonials-slide mediaType='image/svg+xml' imageLink="/images/education_health.svg">
...
<template v-slot:company>Eneza Education</template>
<template v-slot:organisation>Education Service Provider</template>
