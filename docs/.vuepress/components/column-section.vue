...
<!--          <div class="special-grid__image-holder">-->
<!--            <img-->
<!--                src="https://via.placeholder.com/400x400/F8F8F9/DE002B?text=placeholder"-->
<!--                alt="image alt">-->
<!--          </div>-->
<!--          <div class="special-grid__content-holder">-->
<!--            <div class="section-intro__column">-->
...
<!--              <div-->
<!--                  class="section-description">Dictumst habitasse ultrices elementum, consequat ultrices purus volutpat. Posuere amet amet, cum justo bibendum morbi. Auctor interdum morbi non platea justo, et neque.</div>-->
<!--              <router-link-->
<!--                  :to="'test'"-->
<!--                  class="btn btn&#45;&#45;accent"-->
<!--              > Learn more-->
