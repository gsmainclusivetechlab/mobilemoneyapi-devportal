    ...
    <div class="search-results-section">
      <div class="container container--narrow">
        ...
        <glossary-container ref="glossary-co" v-show="visibleResults">
          <glossary-item>
            <template v-slot:title>ATM</template>
          ...
          <glossary-item>
            <template v-slot:title>Agent</template>
          ...
          <glossary-item>
            <template v-slot:title>API Service</template>
          ...
          <glossary-item>
            <template v-slot:title>Application Programming Interfaces (APIs)</template>
          ...
          <glossary-item>
            <template v-slot:title>Authorisation</template>
          ...
          <glossary-item>
            <template v-slot:title>GUID</template>
          ...
          <glossary-item>
            <template v-slot:title>HTTP</template>
          ...
          <glossary-item>
            <template v-slot:title>ISO</template>
          ...
          <glossary-item>
            <template v-slot:title>ITU</template>
          ...
          <glossary-item>
            <template v-slot:title>JSON</template>
          ...
          <glossary-item>
            <template v-slot:title>Merchant</template>
          ...
          <glossary-item>
            <template v-slot:title>MSISDN</template>
          ...
          <glossary-item>
            <template v-slot:title>Object</template>
          ...
          <glossary-item>
            <template v-slot:title>Organisation</template>
          ...
          <glossary-item>
            <template v-slot:title>Provider</template>
            <template v-slot:description>Hosts the Mobile Money API services (or subset of).
            </template>
          </glossary-item>
          <glossary-item>
            <template v-slot:title>Resource</template>
          ...
          <glossary-item>
            <template v-slot:title>REST-based API</template>
          ...
          <glossary-item>
            <template v-slot:title>URI</template>
...
import GlossaryContainer from "./glossary-container";
  ...
  methods: {
    applySearchFilter() {
      this.$refs['glossary-co']?.$children?.forEach(item => {
        if (item.showElement) {
          item.showElement = item.$el.innerText.toLowerCase().includes(this.searchebleValue.toLowerCase())
        }
      });
    },
    ...
    applyLetterFilter() {
      this.$refs['glossary-co']?.$children?.forEach(item => {
        if (this.activeLetter !== 'All') {
          item.showElement = item.$el.innerText.toLowerCase().startsWith(this.activeLetter.toLowerCase());
        } else {
